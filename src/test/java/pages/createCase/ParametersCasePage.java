...
public class ParametersCasePage extends CasePage {
    ...
    public static final By ADD_SHRED_STEP_BUTTON = By.xpath("//button[@type='button']" +
            "//span[text()=' Add shared step']");
    public static final By ADD_VALUE_BUTTON = By.xpath("//button[@type='button']//span[text()='Add value']");
    public static final By REMOVE_PARAMETER_BUTTON = By.xpath("//button[@aria-label='Remove parameter']" +
            "/../../div[@class='uzb236']");
    public static final By REMOVE_PARAMETER_VALUE_BUTTON = By.xpath("//button[@aria-label='Remove parameter value']" +
            "/../../../div[@class='orFHna H4dNGP'][1]");
    ...
    public ParametersCasePage clickAddParameterButton() {
        ...
        log.info("Find element and click " + ADD_PARAMETER_BUTTON);
        return this;
    }
    ...
    public ParametersCasePage clickAddValueButton() {
        ...
        log.info("Find element and click " + ADD_VALUE_BUTTON);
        return this;
    }
    ...
    public ParametersCasePage deleteValue() {
        ...
        log.info("Find element and click " + REMOVE_PARAMETER_VALUE_BUTTON);
        return this;
    }
    ...
    public ParametersCasePage addValueAndWrite(Case caseParameter) {
        clickAddValueButton();
        log.info("Click button " + ADD_VALUE_BUTTON);
        new Input(driver, "Parameter values").write(caseParameter.getParameterValues());
        return this;
    }
    ...
    public ParametersCasePage deleteParameter() {
        ...
        log.info("Find element and click " + REMOVE_PARAMETER_BUTTON);
        return this;
    }
    ...
    public ParametersCasePage clickAddStepButton() {
        ...
        log.info("Find element and click " + ADD_STEP_BUTTON);
        return this;
    }
    ...
    public ParametersCasePage clickAddShredStepButton() {
        ...
        log.info("Find element and click " + ADD_SHRED_STEP_BUTTON);
        return this;
    }
}
